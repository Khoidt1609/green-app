// lib/features/reward/repositories/reward_repository.dart
...
class RewardRepository {
  ...
  // ── Transaction history ───────────────────
  Future<List<TransactionRecord>> getTransactions({int limit = 20}) async {
    final snapshot = await _firestore
        ...
        .limit(limit)
        .get();
    return snapshot.docs.map(TransactionRecord.fromDoc).toList();
  }
}
