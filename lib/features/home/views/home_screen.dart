...
void initState() {
  ...
  void _onTapBottomNav(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        Navigator.of(context).pushNamed(AppRouter.leaderboard);
        break;
      case 2:
        setState(() {
          _currentTab = index;
      ...
      case 3:
        ...
        break;
      case 4:
        Navigator.of(context).pushNamed(AppRouter.store);
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final avatarInitial = (username != null && username.isNotEmpty)
        ...
        final totalPoints = _toInt(_profileData?['totalPoints']);
    final weeklyPoints = _toInt(_profileData?['weeklyPoints']);
    final monthlyPoints = _toInt(_profileData?['monthlyPoints']);
    final streakDays = _toInt(_profileData?['streakDays']);
    final cityRank = _toInt(_profileData?['cityRank']);

    final tasksDone = _tasks.where((task) => (task['done'] as bool?) ?? false).length;
    final achievementItems = _toListOfMap(_profileData?['recentAchievements']);
                        ...
                        children: [
                          ...
                          if (_isLoadingTasks)
                            ...
                            ..._tasks.asMap().entries.map((entry) {
                              ...
                              final dueLabel = (task['dueLabel'] as String?)
                                  ?.trim();
                              ...
                              final card = _TaskCard(
                                ...
                                subtitle:
                                    ...
                                    : 'General',
                                timeLabel:
                                    dueLabel != null && dueLabel.isNotEmpty
                                    ? dueLabel
                                    : (done ? 'Done' : 'Today'),
                                points: done ? '✓' : '+$points',
                                accent: accent,
