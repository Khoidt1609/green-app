...
import '../../../data/models/transaction_model.dart'; // FIX: TransactionModel
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [colorScheme.primary, AppColors.primaryDarkGreen],
...
class _TransactionHistoryTab extends StatelessWidget {
  ...
  // FIX: TransactionRecord → TransactionModel
...
class _TransactionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // FIX: TransactionModel dùng status field trực tiếp
